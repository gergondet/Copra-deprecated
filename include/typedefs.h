...
struct is_all_integral : is_all_integral<typename std::is_integral<typename std::decay<T1>::type>::type, T2, T3> {
};
...
template <typename T2, typename T3>
struct is_all_integral<std::true_type, T2, T3> : is_all_integral<typename std::is_integral<typename std::decay<T2>::type>::type, T3, std::true_type> {
};
